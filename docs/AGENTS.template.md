...
<!-- 🔧 CUSTOMIZE: Add your project skills -->
<!-- Format: |skill-name|path|desc|size -->

```
[Add your skills here in compressed format]
```
...
```typescript
// Add your common code patterns here
```

## Critical Paths

<!-- 🔧 CUSTOMIZE: Add your critical file paths -->
...
---
*Auto-generated registry. Keep docs in `./docs/` structure for consistency.*
