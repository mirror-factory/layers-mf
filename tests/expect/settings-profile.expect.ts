/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/profile.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-profile.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/profile', () => {
