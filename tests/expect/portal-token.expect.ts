/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /portal/[token].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/portal-token.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /portal/[token]', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/portal/sample');
