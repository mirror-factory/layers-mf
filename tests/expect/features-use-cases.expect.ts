/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /features/use-cases.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/features-use-cases.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /features/use-cases', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/features/use-cases');
