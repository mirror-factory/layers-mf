/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /integrations.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/integrations.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /integrations', () => {
