/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /onboarding/connect-tools.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/onboarding-connect-tools.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /onboarding/connect-tools', () => {
