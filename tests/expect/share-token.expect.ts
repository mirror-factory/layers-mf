/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /share/[token].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/share-token.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /share/[token]', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/share/sample');
