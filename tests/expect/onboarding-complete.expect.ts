/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /onboarding/complete.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/onboarding-complete.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /onboarding/complete', () => {
