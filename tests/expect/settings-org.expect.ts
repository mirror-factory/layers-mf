/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/org.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-org.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/org', () => {
