/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /onboarding/choose-template.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/onboarding-choose-template.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /onboarding/choose-template', () => {
