/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/team.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-team.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/team', () => {
