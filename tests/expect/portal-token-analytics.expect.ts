/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /portal/[token]/analytics.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/portal-token-analytics.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /portal/[token]/analytics', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/portal/sample/analytics');
