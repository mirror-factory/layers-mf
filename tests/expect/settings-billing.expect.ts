/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/billing.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-billing.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/billing', () => {
