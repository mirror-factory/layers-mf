/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/org/dashboard.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-org-dashboard.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/org/dashboard', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/settings/org/dashboard');
