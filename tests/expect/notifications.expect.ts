/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /notifications.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/notifications.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /notifications', () => {
