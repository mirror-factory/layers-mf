/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /onboarding/first-session.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/onboarding-first-session.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /onboarding/first-session', () => {
