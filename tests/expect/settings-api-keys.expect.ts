/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/api-keys.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-api-keys.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/api-keys', () => {
