/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/mcp.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-mcp.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/mcp', () => {
