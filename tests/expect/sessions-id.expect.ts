/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /sessions/[id].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/sessions-id.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /sessions/[id]', () => {
