/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/integrations.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-integrations.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/integrations', () => {
