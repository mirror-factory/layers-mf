/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /canvas/[id].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/canvas-id.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /canvas/[id]', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/canvas/sample');
