/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/permissions.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-permissions.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/permissions', () => {
