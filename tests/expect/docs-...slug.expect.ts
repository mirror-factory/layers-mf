/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /docs/[...slug].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/docs-...slug.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /docs/[...slug]', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/docs/sample');
