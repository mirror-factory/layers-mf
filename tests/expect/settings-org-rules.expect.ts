/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /settings/org/rules.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/settings-org-rules.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /settings/org/rules', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/settings/org/rules');
