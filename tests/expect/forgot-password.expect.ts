/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /forgot-password.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/forgot-password.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /forgot-password', () => {
