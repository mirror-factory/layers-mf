/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /how-it-works.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/how-it-works.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /how-it-works', () => {
