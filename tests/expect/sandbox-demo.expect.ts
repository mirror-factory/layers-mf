/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /sandbox/demo.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/sandbox-demo.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /sandbox/demo', () => {
