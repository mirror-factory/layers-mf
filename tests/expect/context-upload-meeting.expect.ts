/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /context/upload-meeting.
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/context-upload-meeting.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /context/upload-meeting', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/context/upload-meeting');
