/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /context/[id].
 *
 ...
 * when ready.
 *
 * Run: pnpm exec expect tests/expect/context-id.expect.ts
 */
import { test, expect } from '@anthropic-ai/expect';

test.describe.skip('expect: /context/[id]', () => {
  test('user can load the page', async ({ page }) => {
    await page.goto('/context/sample');
