/**
 * Auto-scaffolded by sync-registries.ts for portal-analytics-dashboard.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-analytics-dashboard.spec.ts
 *
...
test.describe("visual: portal-analytics-dashboard", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-analytics-dashboard.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-analytics-dashboard-${testInfo.project.name}.png`,
