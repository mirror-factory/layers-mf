/**
 * Auto-scaffolded by sync-registries.ts for docs-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/docs-page.spec.ts
 *
...
test.describe("visual: docs-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering docs-page.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `docs-page-${testInfo.project.name}.png`,
