/**
 * Auto-scaffolded by sync-registries.ts for approval-queue.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/approval-queue.spec.ts
 *
...
test.describe("visual: approval-queue", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering approval-queue.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `approval-queue-${testInfo.project.name}.png`,
