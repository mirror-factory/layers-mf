/**
 * Auto-scaffolded by sync-registries.ts for chat-sdk-explainer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/chat-sdk-explainer.spec.ts
 *
...
test.describe("visual: chat-sdk-explainer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering chat-sdk-explainer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `chat-sdk-explainer-${testInfo.project.name}.png`,
