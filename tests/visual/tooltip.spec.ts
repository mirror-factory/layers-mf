/**
 * Auto-scaffolded by sync-registries.ts for tooltip.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/tooltip.spec.ts
 *
...
test.describe("visual: tooltip", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering tooltip.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `tooltip-${testInfo.project.name}.png`,
