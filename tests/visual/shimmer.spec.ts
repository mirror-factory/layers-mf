/**
 * Auto-scaffolded by sync-registries.ts for shimmer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/shimmer.spec.ts
 *
...
test.describe("visual: shimmer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering shimmer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `shimmer-${testInfo.project.name}.png`,
