/**
 * Auto-scaffolded by sync-registries.ts for changelog-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/changelog-page.spec.ts
 *
...
test.describe("visual: changelog-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering changelog-page.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `changelog-page-${testInfo.project.name}.png`,
