/**
 * Auto-scaffolded by sync-registries.ts for breadcrumbs.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/breadcrumbs.spec.ts
 *
...
test.describe("visual: breadcrumbs", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering breadcrumbs.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `breadcrumbs-${testInfo.project.name}.png`,
