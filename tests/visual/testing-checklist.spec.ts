/**
 * Auto-scaffolded by sync-registries.ts for testing-checklist.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/testing-checklist.spec.ts
 *
...
test.describe("visual: testing-checklist", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering testing-checklist.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `testing-checklist-${testInfo.project.name}.png`,
