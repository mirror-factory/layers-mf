/**
 * Auto-scaffolded by sync-registries.ts for dropdown-menu.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/dropdown-menu.spec.ts
 *
...
test.describe("visual: dropdown-menu", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering dropdown-menu.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `dropdown-menu-${testInfo.project.name}.png`,
