/**
 * Auto-scaffolded by sync-registries.ts for context-annotations.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-annotations.spec.ts
 *
...
test.describe("visual: context-annotations", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-annotations.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-annotations-${testInfo.project.name}.png`,
