/**
 * Auto-scaffolded by sync-registries.ts for inbox-list.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/inbox-list.spec.ts
 *
...
test.describe("visual: inbox-list", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering inbox-list.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `inbox-list-${testInfo.project.name}.png`,
