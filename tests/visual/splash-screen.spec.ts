/**
 * Auto-scaffolded by sync-registries.ts for splash-screen.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/splash-screen.spec.ts
 *
...
test.describe("visual: splash-screen", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering splash-screen.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `splash-screen-${testInfo.project.name}.png`,
