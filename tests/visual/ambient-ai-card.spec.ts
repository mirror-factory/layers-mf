/**
 * Auto-scaffolded by sync-registries.ts for ambient-ai-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/ambient-ai-card.spec.ts
 *
...
test.describe("visual: ambient-ai-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering ambient-ai-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `ambient-ai-card-${testInfo.project.name}.png`,
