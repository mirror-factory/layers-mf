/**
 * Auto-scaffolded by sync-registries.ts for reasoning.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/reasoning.spec.ts
 *
...
test.describe("visual: reasoning", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering reasoning.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `reasoning-${testInfo.project.name}.png`,
