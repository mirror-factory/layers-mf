/**
 * Auto-scaffolded by sync-registries.ts for webhook-health.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/webhook-health.spec.ts
 *
...
test.describe("visual: webhook-health", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering webhook-health.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `webhook-health-${testInfo.project.name}.png`,
