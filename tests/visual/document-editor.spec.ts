/**
 * Auto-scaffolded by sync-registries.ts for document-editor.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/document-editor.spec.ts
 *
...
test.describe("visual: document-editor", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering document-editor.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `document-editor-${testInfo.project.name}.png`,
