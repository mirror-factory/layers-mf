/**
 * Auto-scaffolded by sync-registries.ts for image-loading.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/image-loading.spec.ts
 *
...
test.describe("visual: image-loading", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering image-loading.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `image-loading-${testInfo.project.name}.png`,
