/**
 * Auto-scaffolded by sync-registries.ts for billing-settings.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/billing-settings.spec.ts
 *
...
test.describe("visual: billing-settings", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering billing-settings.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `billing-settings-${testInfo.project.name}.png`,
