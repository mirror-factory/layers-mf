/**
 * Auto-scaffolded by sync-registries.ts for prompt-input.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/prompt-input.spec.ts
 *
...
test.describe("visual: prompt-input", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering prompt-input.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `prompt-input-${testInfo.project.name}.png`,
