/**
 * Auto-scaffolded by sync-registries.ts for checkbox.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/checkbox.spec.ts
 *
...
test.describe("visual: checkbox", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering checkbox.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `checkbox-${testInfo.project.name}.png`,
