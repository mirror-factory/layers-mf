/**
 * Auto-scaffolded by sync-registries.ts for docs-index-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/docs-index-page.spec.ts
 *
...
test.describe("visual: docs-index-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering docs-index-page.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `docs-index-page-${testInfo.project.name}.png`,
