/**
 * Auto-scaffolded by sync-registries.ts for button-group.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/button-group.spec.ts
 *
...
test.describe("visual: button-group", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering button-group.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `button-group-${testInfo.project.name}.png`,
