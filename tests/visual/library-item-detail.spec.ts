/**
 * Auto-scaffolded by sync-registries.ts for library-item-detail.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-item-detail.spec.ts
 *
...
test.describe("visual: library-item-detail", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-item-detail.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-item-detail-${testInfo.project.name}.png`,
