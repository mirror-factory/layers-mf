/**
 * Auto-scaffolded by sync-registries.ts for context-uploader.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-uploader.spec.ts
 *
...
test.describe("visual: context-uploader", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-uploader.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-uploader-${testInfo.project.name}.png`,
