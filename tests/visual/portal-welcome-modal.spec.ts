/**
 * Auto-scaffolded by sync-registries.ts for portal-welcome-modal.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-welcome-modal.spec.ts
 *
...
test.describe("visual: portal-welcome-modal", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-welcome-modal.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-welcome-modal-${testInfo.project.name}.png`,
