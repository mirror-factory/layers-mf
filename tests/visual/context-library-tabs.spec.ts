/**
 * Auto-scaffolded by sync-registries.ts for context-library-tabs.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-library-tabs.spec.ts
 *
...
test.describe("visual: context-library-tabs", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-library-tabs.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-library-tabs-${testInfo.project.name}.png`,
