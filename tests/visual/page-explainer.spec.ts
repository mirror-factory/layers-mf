/**
 * Auto-scaffolded by sync-registries.ts for page-explainer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/page-explainer.spec.ts
 *
...
test.describe("visual: page-explainer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering page-explainer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `page-explainer-${testInfo.project.name}.png`,
