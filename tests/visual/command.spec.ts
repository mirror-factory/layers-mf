/**
 * Auto-scaffolded by sync-registries.ts for command.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/command.spec.ts
 *
...
test.describe("visual: command", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering command.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `command-${testInfo.project.name}.png`,
