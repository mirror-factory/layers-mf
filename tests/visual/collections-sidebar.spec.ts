/**
 * Auto-scaffolded by sync-registries.ts for collections-sidebar.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/collections-sidebar.spec.ts
 *
...
test.describe("visual: collections-sidebar", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering collections-sidebar.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `collections-sidebar-${testInfo.project.name}.png`,
