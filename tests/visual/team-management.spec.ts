/**
 * Auto-scaffolded by sync-registries.ts for team-management.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/team-management.spec.ts
 *
...
test.describe("visual: team-management", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering team-management.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `team-management-${testInfo.project.name}.png`,
