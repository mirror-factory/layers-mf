/**
 * Auto-scaffolded by sync-registries.ts for skills-editor.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/skills-editor.spec.ts
 *
...
test.describe("visual: skills-editor", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering skills-editor.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `skills-editor-${testInfo.project.name}.png`,
