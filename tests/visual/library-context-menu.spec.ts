/**
 * Auto-scaffolded by sync-registries.ts for library-context-menu.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-context-menu.spec.ts
 *
...
test.describe("visual: library-context-menu", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-context-menu.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-context-menu-${testInfo.project.name}.png`,
