/**
 * Auto-scaffolded by sync-registries.ts for mention-picker.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/mention-picker.spec.ts
 *
...
test.describe("visual: mention-picker", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering mention-picker.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `mention-picker-${testInfo.project.name}.png`,
