/**
 * Auto-scaffolded by sync-registries.ts for context-library.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-library.spec.ts
 *
...
test.describe("visual: context-library", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-library.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-library-${testInfo.project.name}.png`,
