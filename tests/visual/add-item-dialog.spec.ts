/**
 * Auto-scaffolded by sync-registries.ts for add-item-dialog.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/add-item-dialog.spec.ts
 *
...
test.describe("visual: add-item-dialog", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering add-item-dialog.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `add-item-dialog-${testInfo.project.name}.png`,
