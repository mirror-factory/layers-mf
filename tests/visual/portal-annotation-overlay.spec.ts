/**
 * Auto-scaffolded by sync-registries.ts for portal-annotation-overlay.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-annotation-overlay.spec.ts
 *
...
test.describe("visual: portal-annotation-overlay", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-annotation-overlay.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-annotation-overlay-${testInfo.project.name}.png`,
