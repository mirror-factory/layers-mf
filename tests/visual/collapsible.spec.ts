/**
 * Auto-scaffolded by sync-registries.ts for collapsible.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/collapsible.spec.ts
 *
...
test.describe("visual: collapsible", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering collapsible.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `collapsible-${testInfo.project.name}.png`,
