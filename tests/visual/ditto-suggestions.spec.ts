/**
 * Auto-scaffolded by sync-registries.ts for ditto-suggestions.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/ditto-suggestions.spec.ts
 *
...
test.describe("visual: ditto-suggestions", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering ditto-suggestions.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `ditto-suggestions-${testInfo.project.name}.png`,
