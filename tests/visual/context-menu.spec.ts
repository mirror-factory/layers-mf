/**
 * Auto-scaffolded by sync-registries.ts for context-menu.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-menu.spec.ts
 *
...
test.describe("visual: context-menu", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-menu.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-menu-${testInfo.project.name}.png`,
