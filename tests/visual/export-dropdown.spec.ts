/**
 * Auto-scaffolded by sync-registries.ts for export-dropdown.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/export-dropdown.spec.ts
 *
...
test.describe("visual: export-dropdown", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering export-dropdown.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `export-dropdown-${testInfo.project.name}.png`,
