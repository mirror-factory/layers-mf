/**
 * Auto-scaffolded by sync-registries.ts for chat-interface.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/chat-interface.spec.ts
 *
...
test.describe("visual: chat-interface", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering chat-interface.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `chat-interface-${testInfo.project.name}.png`,
