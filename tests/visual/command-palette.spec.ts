/**
 * Auto-scaffolded by sync-registries.ts for command-palette.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/command-palette.spec.ts
 *
...
test.describe("visual: command-palette", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering command-palette.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `command-palette-${testInfo.project.name}.png`,
