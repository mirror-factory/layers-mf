/**
 * Auto-scaffolded by sync-registries.ts for library-shell.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-shell.spec.ts
 *
...
test.describe("visual: library-shell", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-shell.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-shell-${testInfo.project.name}.png`,
