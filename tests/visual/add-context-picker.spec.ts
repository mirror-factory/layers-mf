/**
 * Auto-scaffolded by sync-registries.ts for add-context-picker.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/add-context-picker.spec.ts
 *
...
test.describe("visual: add-context-picker", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering add-context-picker.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `add-context-picker-${testInfo.project.name}.png`,
