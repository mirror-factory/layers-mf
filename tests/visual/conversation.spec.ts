/**
 * Auto-scaffolded by sync-registries.ts for conversation.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/conversation.spec.ts
 *
...
test.describe("visual: conversation", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering conversation.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `conversation-${testInfo.project.name}.png`,
