/**
 * Auto-scaffolded by sync-registries.ts for canvas-workspace.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/canvas-workspace.spec.ts
 *
...
test.describe("visual: canvas-workspace", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering canvas-workspace.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `canvas-workspace-${testInfo.project.name}.png`,
