/**
 * Auto-scaffolded by sync-registries.ts for json-render-inline.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/json-render-inline.spec.ts
 *
...
test.describe("visual: json-render-inline", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering json-render-inline.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `json-render-inline-${testInfo.project.name}.png`,
