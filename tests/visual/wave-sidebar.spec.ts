/**
 * Auto-scaffolded by sync-registries.ts for wave-sidebar.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/wave-sidebar.spec.ts
 *
...
test.describe("visual: wave-sidebar", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering wave-sidebar.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `wave-sidebar-${testInfo.project.name}.png`,
