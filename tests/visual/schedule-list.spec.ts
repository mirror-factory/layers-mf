/**
 * Auto-scaffolded by sync-registries.ts for schedule-list.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/schedule-list.spec.ts
 *
...
test.describe("visual: schedule-list", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering schedule-list.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `schedule-list-${testInfo.project.name}.png`,
