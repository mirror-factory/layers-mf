/**
 * Auto-scaffolded by sync-registries.ts for mcp-connect-cards.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/mcp-connect-cards.spec.ts
 *
...
test.describe("visual: mcp-connect-cards", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering mcp-connect-cards.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `mcp-connect-cards-${testInfo.project.name}.png`,
