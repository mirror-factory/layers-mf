/**
 * Auto-scaffolded by sync-registries.ts for message-stats.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/message-stats.spec.ts
 *
...
test.describe("visual: message-stats", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering message-stats.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `message-stats-${testInfo.project.name}.png`,
