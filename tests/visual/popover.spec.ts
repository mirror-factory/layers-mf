/**
 * Auto-scaffolded by sync-registries.ts for popover.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/popover.spec.ts
 *
...
test.describe("visual: popover", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering popover.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `popover-${testInfo.project.name}.png`,
