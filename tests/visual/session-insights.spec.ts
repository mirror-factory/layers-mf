/**
 * Auto-scaffolded by sync-registries.ts for session-insights.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/session-insights.spec.ts
 *
...
test.describe("visual: session-insights", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering session-insights.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `session-insights-${testInfo.project.name}.png`,
