/**
 * Auto-scaffolded by sync-registries.ts for skills-chat.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/skills-chat.spec.ts
 *
...
test.describe("visual: skills-chat", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering skills-chat.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `skills-chat-${testInfo.project.name}.png`,
