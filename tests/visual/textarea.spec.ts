/**
 * Auto-scaffolded by sync-registries.ts for textarea.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/textarea.spec.ts
 *
...
test.describe("visual: textarea", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering textarea.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `textarea-${testInfo.project.name}.png`,
