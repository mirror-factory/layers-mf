/**
 * Auto-scaffolded by sync-registries.ts for entropy.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/entropy.spec.ts
 *
...
test.describe("visual: entropy", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering entropy.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `entropy-${testInfo.project.name}.png`,
