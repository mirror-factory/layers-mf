/**
 * Auto-scaffolded by sync-registries.ts for org-rules.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/org-rules.spec.ts
 *
...
test.describe("visual: org-rules", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering org-rules.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `org-rules-${testInfo.project.name}.png`,
