/**
 * Auto-scaffolded by sync-registries.ts for approval-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/approval-card.spec.ts
 *
...
test.describe("visual: approval-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering approval-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `approval-card-${testInfo.project.name}.png`,
