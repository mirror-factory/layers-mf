/**
 * Auto-scaffolded by sync-registries.ts for agent-swarm.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/agent-swarm.spec.ts
 *
...
test.describe("visual: agent-swarm", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering agent-swarm.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `agent-swarm-${testInfo.project.name}.png`,
