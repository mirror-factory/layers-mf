/**
 * Auto-scaffolded by sync-registries.ts for canvas-toolbar.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/canvas-toolbar.spec.ts
 *
...
test.describe("visual: canvas-toolbar", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering canvas-toolbar.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `canvas-toolbar-${testInfo.project.name}.png`,
