/**
 * Auto-scaffolded by sync-registries.ts for progress.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/progress.spec.ts
 *
...
test.describe("visual: progress", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering progress.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `progress-${testInfo.project.name}.png`,
