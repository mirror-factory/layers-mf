/**
 * Auto-scaffolded by sync-registries.ts for org-settings.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/org-settings.spec.ts
 *
...
test.describe("visual: org-settings", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering org-settings.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `org-settings-${testInfo.project.name}.png`,
