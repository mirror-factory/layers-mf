/**
 * Auto-scaffolded by sync-registries.ts for accordion.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/accordion.spec.ts
 *
...
test.describe("visual: accordion", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering accordion.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `accordion-${testInfo.project.name}.png`,
