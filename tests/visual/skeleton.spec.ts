/**
 * Auto-scaffolded by sync-registries.ts for skeleton.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/skeleton.spec.ts
 *
...
test.describe("visual: skeleton", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering skeleton.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `skeleton-${testInfo.project.name}.png`,
