/**
 * Auto-scaffolded by sync-registries.ts for entity-chips.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/entity-chips.spec.ts
 *
...
test.describe("visual: entity-chips", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering entity-chips.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `entity-chips-${testInfo.project.name}.png`,
