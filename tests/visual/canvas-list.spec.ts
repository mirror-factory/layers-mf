/**
 * Auto-scaffolded by sync-registries.ts for canvas-list.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/canvas-list.spec.ts
 *
...
test.describe("visual: canvas-list", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering canvas-list.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `canvas-list-${testInfo.project.name}.png`,
