/**
 * Auto-scaffolded by sync-registries.ts for content-viewer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/content-viewer.spec.ts
 *
...
test.describe("visual: content-viewer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering content-viewer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `content-viewer-${testInfo.project.name}.png`,
