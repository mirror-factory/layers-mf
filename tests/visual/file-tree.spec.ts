/**
 * Auto-scaffolded by sync-registries.ts for file-tree.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/file-tree.spec.ts
 *
...
test.describe("visual: file-tree", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering file-tree.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `file-tree-${testInfo.project.name}.png`,
