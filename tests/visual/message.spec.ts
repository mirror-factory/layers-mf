/**
 * Auto-scaffolded by sync-registries.ts for message.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/message.spec.ts
 *
...
test.describe("visual: message", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering message.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `message-${testInfo.project.name}.png`,
