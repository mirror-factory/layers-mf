/**
 * Auto-scaffolded by sync-registries.ts for tool.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/tool.spec.ts
 *
...
test.describe("visual: tool", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering tool.
    await page.goto("/");
    await expect(page).toHaveScreenshot(`tool-${testInfo.project.name}.png`, {
      animations: "disabled",
