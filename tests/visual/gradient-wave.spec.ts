/**
 * Auto-scaffolded by sync-registries.ts for gradient-wave.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/gradient-wave.spec.ts
 *
...
test.describe("visual: gradient-wave", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering gradient-wave.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `gradient-wave-${testInfo.project.name}.png`,
