/**
 * Auto-scaffolded by sync-registries.ts for portal-voice-mode.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-voice-mode.spec.ts
 *
...
test.describe("visual: portal-voice-mode", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-voice-mode.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-voice-mode-${testInfo.project.name}.png`,
