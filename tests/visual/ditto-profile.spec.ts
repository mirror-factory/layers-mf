/**
 * Auto-scaffolded by sync-registries.ts for ditto-profile.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/ditto-profile.spec.ts
 *
...
test.describe("visual: ditto-profile", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering ditto-profile.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `ditto-profile-${testInfo.project.name}.png`,
