/**
 * Auto-scaffolded by sync-registries.ts for permission-settings.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/permission-settings.spec.ts
 *
...
test.describe("visual: permission-settings", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering permission-settings.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `permission-settings-${testInfo.project.name}.png`,
