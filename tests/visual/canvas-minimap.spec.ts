/**
 * Auto-scaffolded by sync-registries.ts for canvas-minimap.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/canvas-minimap.spec.ts
 *
...
test.describe("visual: canvas-minimap", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering canvas-minimap.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `canvas-minimap-${testInfo.project.name}.png`,
