/**
 * Auto-scaffolded by sync-registries.ts for sidebar-nav.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/sidebar-nav.spec.ts
 *
...
test.describe("visual: sidebar-nav", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering sidebar-nav.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `sidebar-nav-${testInfo.project.name}.png`,
