/**
 * Auto-scaffolded by sync-registries.ts for profile-settings.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/profile-settings.spec.ts
 *
...
test.describe("visual: profile-settings", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering profile-settings.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `profile-settings-${testInfo.project.name}.png`,
