/**
 * Auto-scaffolded by sync-registries.ts for landing-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/landing-page.spec.ts
 *
...
test.describe("visual: landing-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering landing-page.
    await page.goto("/");
