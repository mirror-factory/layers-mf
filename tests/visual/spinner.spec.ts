/**
 * Auto-scaffolded by sync-registries.ts for spinner.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/spinner.spec.ts
 *
...
test.describe("visual: spinner", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering spinner.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `spinner-${testInfo.project.name}.png`,
