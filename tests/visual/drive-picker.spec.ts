/**
 * Auto-scaffolded by sync-registries.ts for drive-picker.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/drive-picker.spec.ts
 *
...
test.describe("visual: drive-picker", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering drive-picker.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `drive-picker-${testInfo.project.name}.png`,
