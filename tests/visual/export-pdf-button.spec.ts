/**
 * Auto-scaffolded by sync-registries.ts for export-pdf-button.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/export-pdf-button.spec.ts
 *
...
test.describe("visual: export-pdf-button", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering export-pdf-button.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `export-pdf-button-${testInfo.project.name}.png`,
