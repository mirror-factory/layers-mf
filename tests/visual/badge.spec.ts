/**
 * Auto-scaffolded by sync-registries.ts for badge.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/badge.spec.ts
 *
...
test.describe("visual: badge", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering badge.
    await page.goto("/");
    await expect(page).toHaveScreenshot(`badge-${testInfo.project.name}.png`, {
      animations: "disabled",
