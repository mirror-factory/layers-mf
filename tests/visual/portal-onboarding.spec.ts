/**
 * Auto-scaffolded by sync-registries.ts for portal-onboarding.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-onboarding.spec.ts
 *
...
test.describe("visual: portal-onboarding", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-onboarding.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-onboarding-${testInfo.project.name}.png`,
