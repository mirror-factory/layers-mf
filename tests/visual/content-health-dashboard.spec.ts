/**
 * Auto-scaffolded by sync-registries.ts for content-health-dashboard.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/content-health-dashboard.spec.ts
 *
...
test.describe("visual: content-health-dashboard", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering content-health-dashboard.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `content-health-dashboard-${testInfo.project.name}.png`,
