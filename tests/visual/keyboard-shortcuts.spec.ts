/**
 * Auto-scaffolded by sync-registries.ts for keyboard-shortcuts.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/keyboard-shortcuts.spec.ts
 *
...
test.describe("visual: keyboard-shortcuts", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering keyboard-shortcuts.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `keyboard-shortcuts-${testInfo.project.name}.png`,
