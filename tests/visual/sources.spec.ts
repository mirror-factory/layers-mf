/**
 * Auto-scaffolded by sync-registries.ts for sources.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/sources.spec.ts
 *
...
test.describe("visual: sources", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering sources.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `sources-${testInfo.project.name}.png`,
