/**
 * Auto-scaffolded by sync-registries.ts for usage-history.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/usage-history.spec.ts
 *
...
test.describe("visual: usage-history", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering usage-history.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `usage-history-${testInfo.project.name}.png`,
