/**
 * Auto-scaffolded by sync-registries.ts for onboarding-redirect.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/onboarding-redirect.spec.ts
 *
...
test.describe("visual: onboarding-redirect", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering onboarding-redirect.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `onboarding-redirect-${testInfo.project.name}.png`,
