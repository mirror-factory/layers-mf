/**
 * Auto-scaffolded by sync-registries.ts for alert-dialog.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/alert-dialog.spec.ts
 *
...
test.describe("visual: alert-dialog", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering alert-dialog.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `alert-dialog-${testInfo.project.name}.png`,
