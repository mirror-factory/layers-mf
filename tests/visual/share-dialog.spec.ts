/**
 * Auto-scaffolded by sync-registries.ts for share-dialog.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/share-dialog.spec.ts
 *
...
test.describe("visual: share-dialog", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering share-dialog.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `share-dialog-${testInfo.project.name}.png`,
