/**
 * Auto-scaffolded by sync-registries.ts for separator.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/separator.spec.ts
 *
...
test.describe("visual: separator", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering separator.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `separator-${testInfo.project.name}.png`,
