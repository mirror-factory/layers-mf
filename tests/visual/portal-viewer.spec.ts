/**
 * Auto-scaffolded by sync-registries.ts for portal-viewer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-viewer.spec.ts
 *
...
test.describe("visual: portal-viewer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-viewer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-viewer-${testInfo.project.name}.png`,
