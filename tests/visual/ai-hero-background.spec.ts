/**
 * Auto-scaffolded by sync-registries.ts for ai-hero-background.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/ai-hero-background.spec.ts
 *
...
test.describe("visual: ai-hero-background", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering ai-hero-background.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `ai-hero-background-${testInfo.project.name}.png`,
