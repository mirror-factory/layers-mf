/**
 * Auto-scaffolded by sync-registries.ts for skill-creator.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/skill-creator.spec.ts
 *
...
test.describe("visual: skill-creator", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering skill-creator.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `skill-creator-${testInfo.project.name}.png`,
