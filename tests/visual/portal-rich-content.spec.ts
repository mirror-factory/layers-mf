/**
 * Auto-scaffolded by sync-registries.ts for portal-rich-content.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-rich-content.spec.ts
 *
...
test.describe("visual: portal-rich-content", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-rich-content.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-rich-content-${testInfo.project.name}.png`,
