/**
 * Auto-scaffolded by sync-registries.ts for hover-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/hover-card.spec.ts
 *
...
test.describe("visual: hover-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering hover-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `hover-card-${testInfo.project.name}.png`,
