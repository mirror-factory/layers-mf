/**
 * Auto-scaffolded by sync-registries.ts for artifact-detail-view.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/artifact-detail-view.spec.ts
 *
...
test.describe("visual: artifact-detail-view", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering artifact-detail-view.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `artifact-detail-view-${testInfo.project.name}.png`,
