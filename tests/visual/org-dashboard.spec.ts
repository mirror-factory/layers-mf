/**
 * Auto-scaffolded by sync-registries.ts for org-dashboard.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/org-dashboard.spec.ts
 *
...
test.describe("visual: org-dashboard", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering org-dashboard.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `org-dashboard-${testInfo.project.name}.png`,
