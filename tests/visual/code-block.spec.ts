/**
 * Auto-scaffolded by sync-registries.ts for code-block.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/code-block.spec.ts
 *
...
test.describe("visual: code-block", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering code-block.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `code-block-${testInfo.project.name}.png`,
