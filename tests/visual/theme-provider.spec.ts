/**
 * Auto-scaffolded by sync-registries.ts for theme-provider.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/theme-provider.spec.ts
 *
...
test.describe("visual: theme-provider", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering theme-provider.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `theme-provider-${testInfo.project.name}.png`,
