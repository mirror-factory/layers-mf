/**
 * Auto-scaffolded by sync-registries.ts for session-workspace.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/session-workspace.spec.ts
 *
...
test.describe("visual: session-workspace", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering session-workspace.
    await page.goto("/");
