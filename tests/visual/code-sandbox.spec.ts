/**
 * Auto-scaffolded by sync-registries.ts for code-sandbox.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/code-sandbox.spec.ts
 *
...
test.describe("visual: code-sandbox", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering code-sandbox.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `code-sandbox-${testInfo.project.name}.png`,
