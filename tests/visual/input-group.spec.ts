/**
 * Auto-scaffolded by sync-registries.ts for input-group.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/input-group.spec.ts
 *
...
test.describe("visual: input-group", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering input-group.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `input-group-${testInfo.project.name}.png`,
