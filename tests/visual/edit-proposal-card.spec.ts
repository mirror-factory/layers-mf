/**
 * Auto-scaffolded by sync-registries.ts for edit-proposal-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/edit-proposal-card.spec.ts
 *
...
test.describe("visual: edit-proposal-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering edit-proposal-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `edit-proposal-card-${testInfo.project.name}.png`,
