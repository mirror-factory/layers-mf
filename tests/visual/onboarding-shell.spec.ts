/**
 * Auto-scaffolded by sync-registries.ts for onboarding-shell.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/onboarding-shell.spec.ts
 *
...
test.describe("visual: onboarding-shell", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering onboarding-shell.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `onboarding-shell-${testInfo.project.name}.png`,
