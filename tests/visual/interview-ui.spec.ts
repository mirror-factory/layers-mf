/**
 * Auto-scaffolded by sync-registries.ts for interview-ui.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/interview-ui.spec.ts
 *
...
test.describe("visual: interview-ui", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering interview-ui.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `interview-ui-${testInfo.project.name}.png`,
