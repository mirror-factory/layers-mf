/**
 * Auto-scaffolded by sync-registries.ts for dithering-shader.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/dithering-shader.spec.ts
 *
...
test.describe("visual: dithering-shader", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering dithering-shader.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `dithering-shader-${testInfo.project.name}.png`,
