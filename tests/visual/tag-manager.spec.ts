/**
 * Auto-scaffolded by sync-registries.ts for tag-manager.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/tag-manager.spec.ts
 *
...
test.describe("visual: tag-manager", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering tag-manager.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `tag-manager-${testInfo.project.name}.png`,
