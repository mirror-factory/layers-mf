/**
 * Auto-scaffolded by sync-registries.ts for source-badge.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/source-badge.spec.ts
 *
...
test.describe("visual: source-badge", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering source-badge.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `source-badge-${testInfo.project.name}.png`,
