/**
 * Auto-scaffolded by sync-registries.ts for portal-chat.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-chat.spec.ts
 *
...
test.describe("visual: portal-chat", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-chat.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-chat-${testInfo.project.name}.png`,
