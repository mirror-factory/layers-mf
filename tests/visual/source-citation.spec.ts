/**
 * Auto-scaffolded by sync-registries.ts for source-citation.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/source-citation.spec.ts
 *
...
test.describe("visual: source-citation", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering source-citation.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `source-citation-${testInfo.project.name}.png`,
