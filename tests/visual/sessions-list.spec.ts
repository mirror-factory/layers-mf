/**
 * Auto-scaffolded by sync-registries.ts for sessions-list.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/sessions-list.spec.ts
 *
...
test.describe("visual: sessions-list", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering sessions-list.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `sessions-list-${testInfo.project.name}.png`,
