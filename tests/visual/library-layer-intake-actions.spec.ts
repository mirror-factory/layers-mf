/**
 * Auto-scaffolded by sync-registries.ts for library-layer-intake-actions.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-layer-intake-actions.spec.ts
 *
