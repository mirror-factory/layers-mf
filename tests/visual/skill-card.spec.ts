/**
 * Auto-scaffolded by sync-registries.ts for skill-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/skill-card.spec.ts
 *
...
test.describe("visual: skill-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering skill-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `skill-card-${testInfo.project.name}.png`,
