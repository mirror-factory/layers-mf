/**
 * Auto-scaffolded by sync-registries.ts for context-info-panel.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-info-panel.spec.ts
 *
...
test.describe("visual: context-info-panel", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-info-panel.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-info-panel-${testInfo.project.name}.png`,
