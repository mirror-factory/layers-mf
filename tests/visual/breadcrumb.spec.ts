/**
 * Auto-scaffolded by sync-registries.ts for breadcrumb.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/breadcrumb.spec.ts
 *
...
test.describe("visual: breadcrumb", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering breadcrumb.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `breadcrumb-${testInfo.project.name}.png`,
