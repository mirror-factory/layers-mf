/**
 * Auto-scaffolded by sync-registries.ts for schedule-chat.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/schedule-chat.spec.ts
 *
...
test.describe("visual: schedule-chat", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering schedule-chat.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `schedule-chat-${testInfo.project.name}.png`,
