/**
 * Auto-scaffolded by sync-registries.ts for portal-experience.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-experience.spec.ts
 *
...
test.describe("visual: portal-experience", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-experience.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-experience-${testInfo.project.name}.png`,
