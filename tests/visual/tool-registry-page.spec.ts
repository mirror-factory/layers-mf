/**
 * Auto-scaffolded by sync-registries.ts for tool-registry-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/tool-registry-page.spec.ts
 *
...
test.describe("visual: tool-registry-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering tool-registry-page.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `tool-registry-page-${testInfo.project.name}.png`,
