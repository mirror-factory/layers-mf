/**
 * Auto-scaffolded by sync-registries.ts for connectors-view.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/connectors-view.spec.ts
 *
...
test.describe("visual: connectors-view", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering connectors-view.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `connectors-view-${testInfo.project.name}.png`,
