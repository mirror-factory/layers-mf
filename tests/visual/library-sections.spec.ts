/**
 * Auto-scaffolded by sync-registries.ts for library-sections.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-sections.spec.ts
 *
...
test.describe("visual: library-sections", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-sections.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-sections-${testInfo.project.name}.png`,
