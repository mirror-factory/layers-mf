/**
 * Auto-scaffolded by sync-registries.ts for library-layer-dashboard.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-layer-dashboard.spec.ts
 *
...
test.describe("visual: library-layer-dashboard", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-layer-dashboard.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-layer-dashboard-${testInfo.project.name}.png`,
