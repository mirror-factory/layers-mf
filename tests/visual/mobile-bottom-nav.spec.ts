/**
 * Auto-scaffolded by sync-registries.ts for mobile-bottom-nav.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/mobile-bottom-nav.spec.ts
 *
...
test.describe("visual: mobile-bottom-nav", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering mobile-bottom-nav.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `mobile-bottom-nav-${testInfo.project.name}.png`,
