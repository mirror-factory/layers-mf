/**
 * Auto-scaffolded by sync-registries.ts for scroll-area.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/scroll-area.spec.ts
 *
...
test.describe("visual: scroll-area", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering scroll-area.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `scroll-area-${testInfo.project.name}.png`,
