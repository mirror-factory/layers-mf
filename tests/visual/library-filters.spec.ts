/**
 * Auto-scaffolded by sync-registries.ts for library-filters.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/library-filters.spec.ts
 *
...
test.describe("visual: library-filters", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering library-filters.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `library-filters-${testInfo.project.name}.png`,
