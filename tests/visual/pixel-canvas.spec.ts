/**
 * Auto-scaffolded by sync-registries.ts for pixel-canvas.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/pixel-canvas.spec.ts
 *
...
test.describe("visual: pixel-canvas", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering pixel-canvas.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `pixel-canvas-${testInfo.project.name}.png`,
