/**
 * Auto-scaffolded by sync-registries.ts for dwell-tracker.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/dwell-tracker.spec.ts
 *
...
test.describe("visual: dwell-tracker", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering dwell-tracker.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `dwell-tracker-${testInfo.project.name}.png`,
