/**
 * Auto-scaffolded by sync-registries.ts for share-signup-cta.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/share-signup-cta.spec.ts
 *
...
test.describe("visual: share-signup-cta", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering share-signup-cta.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `share-signup-cta-${testInfo.project.name}.png`,
