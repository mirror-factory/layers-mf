/**
 * Auto-scaffolded by sync-registries.ts for notification-bell.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/notification-bell.spec.ts
 *
...
test.describe("visual: notification-bell", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering notification-bell.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `notification-bell-${testInfo.project.name}.png`,
