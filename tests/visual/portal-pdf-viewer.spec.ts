/**
 * Auto-scaffolded by sync-registries.ts for portal-pdf-viewer.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/portal-pdf-viewer.spec.ts
 *
...
test.describe("visual: portal-pdf-viewer", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering portal-pdf-viewer.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `portal-pdf-viewer-${testInfo.project.name}.png`,
