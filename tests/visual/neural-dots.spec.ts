/**
 * Auto-scaffolded by sync-registries.ts for neural-dots.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/neural-dots.spec.ts
 *
...
test.describe("visual: neural-dots", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering neural-dots.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `neural-dots-${testInfo.project.name}.png`,
