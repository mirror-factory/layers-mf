/**
 * Auto-scaffolded by sync-registries.ts for saved-searches.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/saved-searches.spec.ts
 *
...
test.describe("visual: saved-searches", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering saved-searches.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `saved-searches-${testInfo.project.name}.png`,
