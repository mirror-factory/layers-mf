/**
 * Auto-scaffolded by sync-registries.ts for notifications-list.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/notifications-list.spec.ts
 *
...
test.describe("visual: notifications-list", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering notifications-list.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `notifications-list-${testInfo.project.name}.png`,
