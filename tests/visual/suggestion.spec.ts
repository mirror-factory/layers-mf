/**
 * Auto-scaffolded by sync-registries.ts for suggestion.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/suggestion.spec.ts
 *
...
test.describe("visual: suggestion", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering suggestion.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `suggestion-${testInfo.project.name}.png`,
