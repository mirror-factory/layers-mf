/**
 * Auto-scaffolded by sync-registries.ts for canvas-connections.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/canvas-connections.spec.ts
 *
...
test.describe("visual: canvas-connections", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering canvas-connections.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `canvas-connections-${testInfo.project.name}.png`,
