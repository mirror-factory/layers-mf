/**
 * Auto-scaffolded by sync-registries.ts for share-link-button.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/share-link-button.spec.ts
 *
...
test.describe("visual: share-link-button", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering share-link-button.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `share-link-button-${testInfo.project.name}.png`,
