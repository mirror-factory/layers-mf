/**
 * Auto-scaffolded by sync-registries.ts for hero-dithering-card.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/hero-dithering-card.spec.ts
 *
...
test.describe("visual: hero-dithering-card", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering hero-dithering-card.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `hero-dithering-card-${testInfo.project.name}.png`,
