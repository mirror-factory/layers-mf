/**
 * Auto-scaffolded by sync-registries.ts for home-hero.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/home-hero.spec.ts
 *
...
test.describe("visual: home-hero", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering home-hero.
    await page.goto("/");
