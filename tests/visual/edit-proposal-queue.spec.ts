/**
 * Auto-scaffolded by sync-registries.ts for edit-proposal-queue.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/edit-proposal-queue.spec.ts
 *
...
test.describe("visual: edit-proposal-queue", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering edit-proposal-queue.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `edit-proposal-queue-${testInfo.project.name}.png`,
