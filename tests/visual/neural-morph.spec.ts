/**
 * Auto-scaffolded by sync-registries.ts for neural-morph.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/neural-morph.spec.ts
 *
...
test.describe("visual: neural-morph", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering neural-morph.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `neural-morph-${testInfo.project.name}.png`,
