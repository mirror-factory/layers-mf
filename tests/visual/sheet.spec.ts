/**
 * Auto-scaffolded by sync-registries.ts for sheet.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/sheet.spec.ts
 *
...
test.describe("visual: sheet", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering sheet.
    await page.goto("/");
    await expect(page).toHaveScreenshot(`sheet-${testInfo.project.name}.png`, {
      animations: "disabled",
