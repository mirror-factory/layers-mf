/**
 * Auto-scaffolded by sync-registries.ts for partner-settings.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/partner-settings.spec.ts
 *
...
test.describe("visual: partner-settings", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering partner-settings.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `partner-settings-${testInfo.project.name}.png`,
