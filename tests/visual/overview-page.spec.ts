/**
 * Auto-scaffolded by sync-registries.ts for overview-page.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/overview-page.spec.ts
 *
...
test.describe("visual: overview-page", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering overview-page.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `overview-page-${testInfo.project.name}.png`,
