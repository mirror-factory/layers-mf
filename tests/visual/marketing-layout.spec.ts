/**
 * Auto-scaffolded by sync-registries.ts for marketing-layout.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/marketing-layout.spec.ts
 *
...
test.describe("visual: marketing-layout", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering marketing-layout.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `marketing-layout-${testInfo.project.name}.png`,
