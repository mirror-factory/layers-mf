/**
 * Auto-scaffolded by sync-registries.ts for tiptap-editor.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/tiptap-editor.spec.ts
 *
...
test.describe("visual: tiptap-editor", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering tiptap-editor.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `tiptap-editor-${testInfo.project.name}.png`,
