/**
 * Auto-scaffolded by sync-registries.ts for context-version-history.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/context-version-history.spec.ts
 *
...
test.describe("visual: context-version-history", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering context-version-history.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `context-version-history-${testInfo.project.name}.png`,
