/**
 * Auto-scaffolded by sync-registries.ts for mcp-chat.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/mcp-chat.spec.ts
 *
...
test.describe("visual: mcp-chat", () => {
  test("matches baseline", async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering mcp-chat.
    await page.goto("/");
    await expect(page).toHaveScreenshot(
      `mcp-chat-${testInfo.project.name}.png`,
