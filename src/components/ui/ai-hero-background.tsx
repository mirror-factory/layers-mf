...
export function AiHeroBackground() {
  ...
  useEffect(() => {
    ...
    // Match Layers dark background: hsl(168, 14%, 5%) = rgb(11, 15, 14)
    ...
    // Mint accent: hsl(168, 45%, 58%) = rgb(93, 199, 177) = #5dc7b1
    const material = new THREE.MeshBasicMaterial({ color: 0x5dc7b1 });
